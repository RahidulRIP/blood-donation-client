        ...
        <div className="pt-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <motion.div
              ...
              className="lg:col-span-8 bg-white rounded-[3rem]  md:p-12 border border-slate-100 shadow-xl"
            >
              <div className="flex items-center justify-between mb-10 p-3.5 md:p-0">
            ...
            >
              ...
              <div className="bg-white rounded-[3rem] p-2.5 md:p-8 border border-slate-100 shadow-xl flex-1">
                <div className="text-center mb-6">
                  <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em]">
                    System Composition
                  </h3>
                  <p className="text-[9px] font-bold text-slate-300 uppercase">
                    Ratio of Users vs Requests
                  </p>
                </div>
                <div className="h-64">
            ...
            <div className="lg:col-span-12 grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                {
                  label: "Demand Volume",
                  val: totalDonationReqData?.length || 0,
                  icon: <FaFileAlt />,
                  color: "text-red-600",
                  bg: "bg-red-50",
                },
                ...
                >
                  <div
                    className={`w-16 h-16 rounded-2xl ${item.bg} ${item.color} flex items-center justify-center text-2xl shadow-inner`}
                  >
                    {item.icon}
                  </div>
                  <div>
