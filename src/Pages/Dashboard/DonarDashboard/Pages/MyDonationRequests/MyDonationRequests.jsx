...
const MyDonationRequests = () => {
  ...
  return (
    <div className=" md:p-8 space-y-8 animate-fadeIn bg-base-200 min-h-screen">
      {/* --- PREMIUM HEADER --- */}
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 border-b border-gray-200 pb-8">
        <div>
          ...
          <h1 className="text-4xl font-black  tracking-tight">
            My Donation{" "}
            <span className="text-transparent bg-clip-text bg-linear-to-r from-red-600 to-rose-400">
              Requests
            </span>
          </h1>
          <p className="text-gray-500 mt-2 font-medium">
            Manage and track your blood donation history
          </p>
        </div>
          ...
          <div className="space-y-6">
            <div className="relative">
              ...
              <input
                ...
                className="input input-lg w-full pl-14 bg-gray-50 text-gray-500 border-none focus:ring-2 focus:ring-red-500/20 transition-all rounded-3xl text-sm font-medium"
                value={searchTerm}
                onChange={(e) => {
          ...
          <table className="table w-full border-collapse">
            ...
            <tbody className="divide-y divide-gray-50">
              {paginatedData.map((data, i) => (
                ...
                >
                  <td className="pl-10 text-gray-300 font-mono text-[10px]">
                    #{(currentPage - 1) * itemsPerPage + i + 1}
                  </td>
                  <td>
                    <div className="flex flex-col">
                      <span className="font-black text-gray-800 text-sm group-hover:text-red-600 transition-colors">
                        {data.recipient_name}
                      </span>
                  ...
                  <td>
                    <div className="flex flex-col gap-1">
                      ...
                      <span className="text-[10px] font-medium text-gray-400 pl-5 uppercase">
                  ...
                  <td>
                    <div className="flex flex-col gap-1">
                      ...
                      <span className="text-[10px] font-medium text-gray-400 pl-5">
                        {data.donation_time}
                      </span>
                    </div>
                  </td>
                  <td>
                    <div
                      className={`badge badge-md border-none px-4 py-3 rounded-xl font-black text-[9px] uppercase tracking-tighter ${
                  ...
                  <td className="pr-10">
                    <div className="flex items-center justify-end gap-3">
                      <Link
                        ...
                        className="p-2.5 bg-white shadow-sm border border-gray-100 text-blue-500 rounded-2xl hover:bg-blue-600 hover:text-white hover:-translate-y-1 transition-all"
                      >
                        <FaEdit size={16} />
                      </Link>
                      <button
                        onClick={() => handleDelete(data._id)}
                        className="p-2.5 bg-white shadow-sm border border-gray-100 text-red-500 rounded-2xl hover:bg-red-600 hover:text-white hover:-translate-y-1 transition-all"
                      >
                        <FaTrashAlt size={16} />
                      </button>
                      <Link
                        to={`/dashboard/detailsDonarReqData/${data._id}`}
                        className="p-2.5 bg-white shadow-sm border border-gray-100 text-gray-400 rounded-2xl hover:bg-gray-800 hover:text-white hover:-translate-y-1 transition-all"
                      >
                        <FaEye size={16} />
                      </Link>
          ...
          <div className="join p-1 bg-white shadow-xl shadow-gray-200/50 rounded-2xl border border-gray-100">
            {[...Array(totalPages).keys()].map((p) => (
              <button
                ...
                className={`join-item btn btn-md border-none px-6 rounded-xl transition-all ${
                  currentPage === p + 1
                    ? "bg-red-600 text-white shadow-lg shadow-red-200 hover:bg-red-700"
                    : "bg-transparent text-gray-400 hover:bg-gray-50 hover:text-gray-800"
                }`}
              >
                {p + 1}
              </button>
